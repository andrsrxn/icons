...
function ToastIcon({ type }: { type: string | undefined }) {
  ...
  if (type === 'warning') {
    icon = <IconWarningTriangle aria-hidden='true' />
  }

  if (type === 'error') {
    icon = <IconWarningOctagon className='text-destructive' aria-hidden='true' />
  }

  if (type === 'loading') {
    icon = <IconSpinner className='animate-spin' aria-hidden='true' />
  }
