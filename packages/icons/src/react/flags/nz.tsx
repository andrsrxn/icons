...
export const IconFlagNZ: FlagIcon = ({
  className,
  size,
  width = size ?? 24,
  height = size,
  ...
  return (
    <svg
      ...
      data-slot='icon-flag-nz'
      role={isHidden ? undefined : 'img'}
      aria-hidden={isHidden ? true : undefined}
      aria-label={isHidden ? undefined : ariaLabel}
      aria-labelledby={showTitle ? 'nz-title' : undefined}
      focusable={isHidden ? false : undefined}
      className={`icon-flag ${className ?? ''}`}
      {...props}>
      {showTitle ? <title id={'nz-title'}>{titleText}</title> : null}

      <defs>
        <defs>
          <linearGradient id='nz-a' x1='50%' x2='50%' y1='0%' y2='100%'>
            <stop offset='0%' stopColor='#fff' />
            <stop offset='100%' stopColor='#f0f0f0' />
          </linearGradient>
          <linearGradient id='nz-b' x1='50%' x2='50%' y1='0%' y2='100%'>
            <stop offset='0%' stopColor='#0a17a7' />
            <stop offset='100%' stopColor='#030e88' />
          </linearGradient>
          <linearGradient id='nz-c' x1='50%' x2='50%' y1='0%' y2='100%'>
      ...
      <g clipPath='url(#nz-clip)'>
        <g fill='none' fillRule='evenodd'>
          ...
          />
          <path fill='url(#nz-c)' d='M0 3h4V0h1v3h4v1H5v3H4V4H0z' />
          <path
            fill='#ca1931'
            d='m15 13-.707.207.207-.707-.207-.707L15 12l.707-.207-.207.707.207.707zM15 3.5l-.707.207L14.5 3l-.207-.707L15 2.5l.707-.207L15.5 3l.207.707zM18 6.5l-.707.207L17.5 6l-.207-.707L18 5.5l.707-.207L18.5 6l.207.707zM12 7.5l-.707.207L11.5 7l-.207-.707L12 6.5l.707-.207L12.5 7l.207.707z'
          />
        </g>
      </g>
    </svg>
