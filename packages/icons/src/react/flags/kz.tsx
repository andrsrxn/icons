...
export const IconFlagKZ: FlagIcon = ({
  className,
  size,
  width = size ?? 24,
  height = size,
  'aria-label': ariaLabel = 'KZ',
    ...
    <svg
      ...
      <g clipPath='url(#kz-clip)'>
        <g fill='none' fillRule='evenodd'>
          <path fill='url(#kz-a)' d='M0 0h21v15H0z' />
          <path fill='url(#kz-b)' d='M0 0h21v15H0z' />
          <circle cx='10.5' cy='7.5' r='3' fill='url(#kz-c)' />
          <path
            fill='url(#kz-c)'
