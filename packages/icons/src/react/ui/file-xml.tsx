...
export const IconFileXml: Icon = ({
  ...
  return (
    <svg
      ...
      {...props}>
      {isLabelled && title && !ariaLabel ? <title id={'file-xml-title'}>{title}</title> : null}
      <path
        opacity='.2'
      ...
      />
      <path
        d='M13.11 3.16v1.89c0 1.89 0 2.83.58 3.42.59.58 1.53.58 3.42.58H19M3.46 21.5l4.07-5.87m0 5.87-4.07-5.87m14.38-.07v5.94m3.16 0h-3.16m-7.64-5.88v5.85m.07-5.88 2.42 2.94m2.35-2.94-2.35 2.95m2.35-2.92v5.85'
        stroke='currentColor'
      />
    </svg>
  )
