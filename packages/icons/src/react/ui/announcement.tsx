...
export const IconAnnouncement: Icon = ({
  ...
  return (
    <svg
      ...
      data-slot='icon-ui-announcement'
      ...
      {...props}>
      {isLabelled && title && !ariaLabel ? <title id={'announcement-title'}>{title}</title> : null}
      <path
        opacity='.2'
      ...
      <path
        ...
        stroke='currentColor'
      />
      <path d='M9.98 7.22 10 18.45a1.58 1.58 0 0 1-3.04.64l-1.82-4.2' stroke='currentColor' />
    </svg>
  )
}
