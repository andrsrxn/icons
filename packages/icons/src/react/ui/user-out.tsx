...
export const IconUserOut: Icon = ({
  ...
  return (
    <svg
      ...
      <path d='M19.04 16.1v5.8' stroke='currentColor' />
      <path
        d='m22.15 20.01-.28.28c-1.33 1.34-2 2-2.83 2s-1.5-.66-2.83-2l-.29-.28'
        stroke='currentColor'
      />
    </svg>
  )
