...
export const IconCreditCardX: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      data-slot='icon-ui-credit-card-x'
      ...
      />
      <path
        d='M14.74 19.78H7.66c-2.82 0-4.24 0-5.12-.88s-.88-2.3-.88-5.12v-3.56c0-2.82 0-4.24.88-5.12s2.3-.88 5.12-.88h8.68c2.82 0 4.24 0 5.12.88s.88 2.3.88 5.12v2.02'
        stroke='currentColor'
      />
      <path d='M1.66 9.38H22' stroke='currentColor' />
      <path d='M4.97 12.84H10' stroke='currentColor' />
      <path d='m18.63 20 4.08-4.07' stroke='currentColor' />
      <path d='m22.7 20.01-4.07-4.07' stroke='currentColor' />
    </svg>
  )
}
