...
export const IconCamping: Icon = ({
  ...
  return (
    <svg
      ...
      {...props}>
      {isLabelled && title && !ariaLabel ? <title id={'camping-title'}>{title}</title> : null}
      <path
        opacity='.2'
      ...
      <path
        ...
        stroke='currentColor'
      />
      <circle cx='6.78' cy='5.08' r='2.24' stroke='currentColor' />
      <path d='m7.2 11.05 4.3 9.65' stroke='currentColor' />
    </svg>
  )
}
