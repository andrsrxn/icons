...
export const IconCreditCardMinus: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      data-slot='icon-ui-credit-card-minus'
      ...
      />
      <path
        d='M14.15 19.78H7.66c-2.82 0-4.24 0-5.12-.88s-.88-2.3-.88-5.12v-3.56c0-2.82 0-4.24.88-5.12s2.3-.88 5.12-.88h8.68c2.82 0 4.24 0 5.12.88s.88 2.3.88 5.12v2.37'
        stroke='currentColor'
      />
