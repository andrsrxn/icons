...
export const IconFileOut: Icon = ({
  ...
  return (
    <svg
      ...
      />
      <path
        d='M20.1 12.82v-2.56c0-1.25 0-1.87-.24-2.43s-.68-1-1.57-1.87L17.1 4.81l-1.24-1.23c-.87-.87-1.3-1.3-1.85-1.53s-1.17-.23-2.39-.23h-1.9c-2.83 0-4.25 0-5.13.88S3.72 5 3.72 7.82v8.42c0 2.83 0 4.24.87 5.12.88.88 2.3.88 5.13.88h2.94'
        stroke='currentColor'
      />
      <path d='M13.13 2.34v2.45c0 1.9 0 2.84.58 3.42s1.53.59 3.42.59h2.46' stroke='currentColor' />
      <path d='M18.3 16.74v6.2' stroke='currentColor' />
      <path
        d='m21.37 18.87-.94-.94c-1-1-1.5-1.5-2.13-1.5s-1.12.5-2.12 1.5l-.95.94'
        stroke='currentColor'
      />
    </svg>
  )
