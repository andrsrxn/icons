...
export const IconUserMove: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      <path
        d='m19.83 22.7.52-.52c1.34-1.33 2-2 2-2.83s-.66-1.5-2-2.83l-.52-.52'
        stroke='currentColor'
      />
      <path d='M15.4 19.35h6.81' stroke='currentColor' />
    </svg>
  )
}
