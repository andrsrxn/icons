...
export const IconFolderPin: Icon = ({
  ...
  return (
    <svg
      ...
      />
      <path
        d='M18.67 20.46c-1.42 0-2.13 0-2.43-.46s.01-1.11.62-2.4l.8-1.69a.9.9 0 0 0-.23-1.06.88.88 0 0 1 .56-1.56h2.67a.9.9 0 0 1 .6 1.58.9.9 0 0 0-.23 1.03l.76 1.77c.55 1.26.82 1.9.52 2.34-.3.45-.98.45-2.35.45z'
        stroke='currentColor'
      />
      <path d='M19.3 22.36V20.6' stroke='currentColor' />
    </svg>
  )
}
