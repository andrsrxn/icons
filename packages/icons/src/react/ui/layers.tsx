...
export const IconLayers: Icon = ({
  ...
  return (
    <svg
      ...
      <path
        opacity='.2'
        d='m2.28 6.33 8.6-3.38a3 3 0 0 1 2.2 0l8.63 3.38a1 1 0 0 1 .02 1.86l-8.6 3.6a3 3 0 0 1-2.32 0l-8.55-3.6a1 1 0 0 1 .02-1.86'
        fill='currentColor'
      />
      <path
      ...
      />
      <path
        d='m18.24 14.28 1.04.39c2 .75 3 1.12 3 1.8.02.68-.96 1.1-2.93 1.92L14.3 20.5c-1.15.48-1.72.72-2.33.72-.6 0-1.17-.24-2.32-.73l-5.1-2.15c-1.93-.81-2.9-1.22-2.88-1.9 0-.67.98-1.04 2.94-1.8l.94-.37'
        stroke='currentColor'
      />
    </svg>
  )
