  ...
  return (
    <svg
      ...
      <path
        ...
        fill='currentColor'
      />
      <path d='m11.58 7.49 1.5-1.41a1.5 1.5 0 0 0-2.05-2.2l-4.1 3.76' stroke='currentColor' />
      <path
      ...
      <path d='m18.07 17.42 1.07-1.02a1.49 1.49 0 1 0-2.05-2.16l-2.1 2.01' stroke='currentColor' />
    </svg>
  )
}
