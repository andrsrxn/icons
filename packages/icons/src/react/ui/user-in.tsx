...
export const IconUserIn: Icon = ({
  ...
  return (
    <svg
      ...
      <path
        d='m22.01 18.33-.15-.16c-1.34-1.34-2-2-2.83-2s-1.5.66-2.83 2l-.16.16'
        stroke='currentColor'
      />
      <path d='M19.02 22.37v-5.85' stroke='currentColor' />
    </svg>
  )
}
