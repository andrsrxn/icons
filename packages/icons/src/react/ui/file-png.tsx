...
export const IconFilePng: Icon = ({
  ...
  return (
    <svg
      ...
      {...props}>
      {isLabelled && title && !ariaLabel ? <title id={'file-png-title'}>{title}</title> : null}
      <path
        opacity='.2'
      ...
      />
      <path
        d='M13.11 3.16v1.89c0 1.89 0 2.83.58 3.42.59.58 1.53.58 3.42.58H19M3 15.56v5.88m.02-5.88h2.1c.88 0 1.6.76 1.6 1.69s-.72 1.68-1.6 1.68h-2.1m18.38-.37a3 3 0 1 1-1.64-2.67m-.97 2.67h2.6M9.15 15.6v5.95m.07-5.99 3.76 6m0-5.96v5.95'
        stroke='currentColor'
      />
    </svg>
  )
