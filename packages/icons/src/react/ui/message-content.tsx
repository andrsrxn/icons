...
export const IconMessageContent: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      data-slot='icon-ui-message-content'
      ...
      <path
        ...
        fill='currentColor'
      />
      <path d='M15.3 14.26H7.74' stroke='currentColor' />
      <path d='M17.7 9.93H7.74' stroke='currentColor' />
      <path
