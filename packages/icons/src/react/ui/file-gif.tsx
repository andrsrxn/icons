...
export const IconFileGif: Icon = ({
  ...
  return (
    <svg
      ...
      {...props}>
      {isLabelled && title && !ariaLabel ? <title id={'file-gif-title'}>{title}</title> : null}
      <path
        opacity='.2'
      ...
      />
      <path
        d='M13.11 3.16v1.89c0 1.89 0 2.83.58 3.42.59.58 1.53.58 3.42.58H19m-2.96 6.55v5.86m-8.74-3h2.61m6.39-2.86h3.8m-4.06 3.44h3.05m-6.29 2.42v-5.87m-2.89 2.87a3 3 0 1 1-1.63-2.67'
        stroke='currentColor'
      />
    </svg>
  )
