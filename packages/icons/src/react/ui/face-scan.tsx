...
export const IconFaceScan: Icon = ({
  ...
  return (
    <svg
      ...
      {...props}>
      {isLabelled && title && !ariaLabel ? <title id={'face-scan-title'}>{title}</title> : null}
      <path
      ...
      <circle
        ...
        fill='currentColor'
      />
      <circle cx='12' cy='12' r='6.34' transform='rotate(90 12 12)' stroke='currentColor' />
      <path
        d='M10.53 10.48a.41.41 0 1 1-.83 0 .41.41 0 0 1 .83 0m3.77 0a.41.41 0 1 1-.83 0 .41.41 0 0 1 .83 0'
        fill='currentColor'
        stroke='currentColor'
      />
      <path d='M13.96 14.15c-.42.38-1.09.63-1.96.63s-1.5-.28-1.96-.63' stroke='currentColor' />
    </svg>
  )
}
