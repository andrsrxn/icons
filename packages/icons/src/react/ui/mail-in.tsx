...
export const IconMailIn: Icon = ({
  ...
  return (
    <svg
      ...
      />
      <path
        d='M22.25 11.04V10c0-2.83 0-4.24-.88-5.12S19.07 4 16.25 4h-8.5c-2.83 0-4.24 0-5.12.88s-.88 2.3-.88 5.12v4c0 2.83 0 4.24.88 5.12s2.3.88 5.12.88h5.48'
        stroke='currentColor'
      />
      <path
      ...
      />
      <path
        d='m22.37 16.78-.06-.06c-1.33-1.34-2-2-2.83-2s-1.5.66-2.83 2l-.06.06'
        stroke='currentColor'
      />
      <path d='M19.48 21.25v-6.53' stroke='currentColor' />
    </svg>
  )
}
