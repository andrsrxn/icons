...
export const IconFaceFilter: Icon = ({
  ...
  return (
    <svg
      ...
      {...props}>
      {isLabelled && title && !ariaLabel ? <title id={'face-filter-title'}>{title}</title> : null}
      <path
        opacity='.2'
        d='M12 21.43a9.43 9.43 0 1 1 5.35-17.2c.34 1.01 1.11 2.14 2.22 2.14A9.43 9.43 0 0 1 12 21.43'
        fill='currentColor'
      />
      <path d='M13.73 2.75a9.43 9.43 0 1 0 7.7 9.25c0-.38 0-1.13-.15-1.8' stroke='currentColor' />
      <path
