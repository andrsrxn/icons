...
export const IconCable: Icon = ({
  ...
  return (
    <svg
      ...
      <path
        d='M7.76 18.72h8.44c1.29 0 1.93 0 2.4-.29a2 2 0 0 0 .7-.7c.28-.49.27-1.13.26-2.42-.02-1.25-.02-1.88-.3-2.35a2 2 0 0 0-.7-.69c-.48-.27-1.1-.27-2.36-.27H7.62c-1.2 0-1.8 0-2.24-.25a2 2 0 0 1-.8-.82c-.25-.45-.24-1.05-.22-2.24.01-1.16.02-1.75.26-2.19a2 2 0 0 1 .8-.8c.45-.23 1.03-.23 2.2-.23h8.48'
        stroke='currentColor'
      />
    </svg>
  )
