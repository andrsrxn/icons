  ...
  return (
    <svg
      ...
      <path
        ...
        stroke='currentColor'
      />
      <circle cx='12' cy='12.91' r='3.97' transform='rotate(90 12 12.9)' stroke='currentColor' />
    </svg>
  )
}
