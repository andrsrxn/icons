...
export const IconFolderDownload: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      data-slot='icon-ui-folder-download'
      ...
      <path
        ...
        stroke='currentColor'
      />
      <path d='M11.97 10.5v5.83' stroke='currentColor' />
      <path
        d='m14.94 14.85-.14.14c-1.33 1.33-2 2-2.83 2s-1.5-.67-2.83-2L9 14.85'
        stroke='currentColor'
      />
    </svg>
  )
