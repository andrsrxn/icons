...
export const IconMoneyOut: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      <path d='M19.76 19.73v-5.01' stroke='currentColor' />
      <path
        d='m22.24 18.01-.35.36c-1 1-1.5 1.5-2.13 1.5s-1.12-.5-2.12-1.5l-.36-.36'
        stroke='currentColor'
      />
    </svg>
  )
