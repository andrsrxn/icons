...
export const IconMessageX: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      <path
        ...
        stroke='currentColor'
      />
      <path d='M16.14 8.87 9.1 15.91' stroke='currentColor' />
      <path d='m9.1 8.86 7.04 7.04' stroke='currentColor' />
    </svg>
  )
}
