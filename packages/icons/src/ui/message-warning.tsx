...
export const IconMessageWarning: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      data-slot='icon-ui-message-warning'
      ...
      <path
        ...
        stroke='currentColor'
      />
      <path d='M12.4 12.34v-5.1' stroke='currentColor' />
      <path
        d='M13 16.54a.6.6 0 1 1-1.19 0 .6.6 0 0 1 1.19 0'
        fill='currentColor'
        stroke='currentColor'
      />
    </svg>
