...
export const IconInvoice: Icon = ({
  ...
  return (
    <svg
      ...
      />
      <path
        d='M15.69 8.33c-.34-.95-1.89-1.69-3.72-1.69-1.82 0-3.82.64-3.82 2.56 0 3.76 7.31.83 7.65 4.54.16 1.76-1.96 2.72-3.83 2.72-1.86 0-3.22-.74-3.82-1.72'
        stroke='currentColor'
      />
      <path d='M11.98 17.72V5.38' stroke='currentColor' />
    </svg>
  )
}
