...
export const IconBookOpenContent: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      data-slot='icon-ui-book-open-content'
      ...
      <path
        ...
        stroke='currentColor'
      />
      <path d='M19.15 7.8a8 8 0 0 0-2.17-.22 7 7 0 0 0-1.87.23' stroke='currentColor' />
      <path d='M19.15 11.77a8 8 0 0 0-2.17-.23 7 7 0 0 0-1.87.23' stroke='currentColor' />
      <path d='M19.15 15.74a8 8 0 0 0-2.17-.23 7 7 0 0 0-1.87.23' stroke='currentColor' />
    </svg>
  )
}
