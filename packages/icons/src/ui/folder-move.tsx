...
export const IconFolderMove: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      />
      <path
        d='m13.39 17.03.5-.5c1.33-1.34 2-2 2-2.83s-.67-1.5-2-2.83l-.5-.5'
        stroke='currentColor'
      />
      <path d='M7.96 13.7h7.8' stroke='currentColor' />
    </svg>
  )
}
