...
export const IconPinFilled: Icon = ({
  ...
  return (
    <svg
      ...
      />
      <path
        d='M4.65 16.08c-1.87-1.86-2.8-2.8-2.6-3.83.18-1.03 1.39-1.57 3.8-2.65l6.8-3.03c.31-.14.46-.2.6-.3a2 2 0 0 0 .8-1.01l.13-.64c.2-1.04.29-1.56.47-1.87a2 2 0 0 1 2.56-.8c.32.15.7.52 1.45 1.27l2.1 2.11c.84.83 1.26 1.25 1.4 1.63a2 2 0 0 1-.65 2.35c-.33.24-.9.38-2.04.66-.35.08-.52.13-.67.2a2 2 0 0 0-.84.67c-.1.14-.17.3-.33.61l-3.28 6.81c-1.11 2.32-1.67 3.47-2.69 3.65s-1.92-.74-3.74-2.55z'
        stroke='currentColor'
      />
