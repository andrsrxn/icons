...
export const IconWarningDiamond: Icon = ({
  ...
  return (
    <svg
      ...
      />
      <path
        d='M7.71 4.8C9.73 2.74 10.74 1.7 12 1.7s2.27 1.04 4.29 3.1l1.44 1.47 1.47 1.44c2.06 2.02 3.1 3.03 3.1 4.29s-1.04 2.27-3.1 4.29l-1.47 1.44-1.44 1.47c-2.02 2.06-3.03 3.1-4.29 3.1s-2.27-1.04-4.29-3.1l-1.44-1.47-1.47-1.44C2.74 14.27 1.7 13.26 1.7 12s1.04-2.27 3.1-4.29l1.47-1.44z'
        stroke='currentColor'
      />
