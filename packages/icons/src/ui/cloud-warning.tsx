...
export const IconCloudWarning: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      data-slot='icon-ui-cloud-warning'
      ...
      <path
        ...
        stroke='currentColor'
      />
      <path d='M12 16.34v-3.75' stroke='currentColor' />
      <path
        d='M12.42 19.35a.42.42 0 1 1-.84 0 .42.42 0 0 1 .84 0'
        fill='currentColor'
        stroke='currentColor'
      />
    </svg>
