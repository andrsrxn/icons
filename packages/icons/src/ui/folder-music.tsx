...
export const IconFolderMusic: Icon = ({
  ...
  return (
    <svg
      ...
      />
      <path
        d='m22.24 10.25-.01-.66a3 3 0 0 0-2.7-2.7l-.66-.01H14.2c-1.04 0-1.56 0-2.05-.17l-.2-.08c-.48-.2-.86-.56-1.62-1.27S9.17 4.29 8.7 4.09L8.5 4c-.48-.16-1-.16-2.05-.16h-2.2A2.57 2.57 0 0 0 1.67 6.4v7.77c0 2.83 0 4.24.88 5.12s2.3.88 5.12.88h6.2'
        stroke='currentColor'
      />
      <path
        ...
        stroke='currentColor'
      />
      <path d='M20.85 19.3v-3.67c0-.51.25-1 .68-1.28l1.04-.68' stroke='currentColor' />
    </svg>
  )
}
