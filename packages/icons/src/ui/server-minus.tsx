...
export const IconServerMinus: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      data-slot='icon-ui-server-minus'
      ...
      <path
        opacity='.2'
        d='M4.84 21.23c-.98 0-1.48 0-1.86-.17a2 2 0 0 1-1.03-1.03c-.17-.38-.17-.88-.17-1.86s0-1.48.17-1.86a2 2 0 0 1 1.03-1.03c.38-.17.88-.17 1.86-.17h14.32c.98 0 1.48 0 1.86.17a2 2 0 0 1 1.03 1.03c.17.38.17.87.17 1.86 0 .98 0 1.48-.17 1.86a2 2 0 0 1-1.03 1.03c-.38.17-.88.17-1.86.17z'
        fill='currentColor'
      />
      <rect
        x='1.78'
      ...
      <path
        ...
        stroke='currentColor'
      />
      <path d='M16.52 18.17h6.04' stroke='currentColor' />
    </svg>
  )
}
