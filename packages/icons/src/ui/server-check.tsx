...
export const IconServerCheck: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      data-slot='icon-ui-server-check'
      ...
      <path
        opacity='.2'
        d='M4.84 21.23c-.98 0-1.48 0-1.86-.17a2 2 0 0 1-1.03-1.03c-.17-.38-.17-.88-.17-1.86s0-1.48.17-1.86a2 2 0 0 1 1.03-1.03c.38-.17.88-.17 1.86-.17H20.6a1.6 1.6 0 0 1 1.23 2.64L20.1 19.8c-.59.7-.88 1.05-1.28 1.24s-.86.19-1.78.19z'
        fill='currentColor'
      />
      <rect
        x='1.78'
      ...
      />
      <path
        d='M13.23 15.11H4.84c-.98 0-1.48 0-1.86.17a2 2 0 0 0-1.03 1.03c-.17.38-.17.87-.17 1.86 0 .98 0 1.48.17 1.86a2 2 0 0 0 1.03 1.03c.38.17.88.17 1.86.17h8.4'
        stroke='currentColor'
      />
      <path
      ...
      />
      <path
        d='m16.46 19.01.4.51c.73.91 1.1 1.37 1.57 1.36.49 0 .85-.45 1.57-1.37l2.6-3.3'
        stroke='currentColor'
      />
    </svg>
  )
