...
export const IconCloudRainWind: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      data-slot='icon-ui-cloud-rain-wind'
      ...
      <path
        ...
        fill='currentColor'
      />
      <path d='m9.3 14.37-1.32 4.1' stroke='currentColor' />
      <path d='M13.16 14.05 12 17.84' stroke='currentColor' />
      <path d='m16.35 15.95-1.2 4.2' stroke='currentColor' />
