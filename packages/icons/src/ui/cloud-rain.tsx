...
export const IconCloudRain: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      <path
        ...
        fill='currentColor'
      />
      <path d='M8.77 15.24v3.25' stroke='currentColor' />
      <path d='M12.44 14.2v3.24' stroke='currentColor' />
      <path d='M15.84 16.16v3.25' stroke='currentColor' />
