...
export const IconServerMove: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      />
      <path
        d='M20.41 15.32c1.35 1.35 2.02 2.02 2.02 2.85s-.67 1.5-2.02 2.85'
        stroke='currentColor'
      />
      <path d='M16.8 18.17h5.33' stroke='currentColor' />
    </svg>
  )
}
