...
export const IconLayersHalf: Icon = ({
  ...
  return (
    <svg
      ...
      <path
        opacity='.2'
        d='m10.81 18.7-8.55-3.6a1 1 0 0 1 .02-1.85l3.34-1.31a1 1 0 0 1 .73 0l4.53 1.78a3 3 0 0 0 2.2 0l4.54-1.78a1 1 0 0 1 .73 0l3.36 1.31a1 1 0 0 1 .02 1.85l-8.6 3.61a3 3 0 0 1-2.32 0'
        fill='currentColor'
      />
    </svg>
  )
