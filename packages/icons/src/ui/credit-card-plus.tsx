...
export const IconCreditCardPlus: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      data-slot='icon-ui-credit-card-plus'
      ...
      />
      <path
        d='M14.15 19.78H7.66c-2.82 0-4.24 0-5.12-.88s-.88-2.3-.88-5.12v-3.56c0-2.82 0-4.24.88-5.12s2.3-.88 5.12-.88h8.68c2.82 0 4.24 0 5.12.88s.88 2.3.88 5.12v1.8'
        stroke='currentColor'
      />
      <path d='M1.66 9.38H22' stroke='currentColor' />
      <path d='M16.85 17.3h5.64' stroke='currentColor' />
      <path d='M19.66 20.13v-5.64' stroke='currentColor' />
