...
export const IconDatabasePlus: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      data-slot='icon-ui-database-plus'
      ...
      <path d='M20.88 5.74v6.15' stroke='currentColor' />
      <path d='M3.12 5.74V18.6' stroke='currentColor' />
      <path d='M17.43 19.6h5.2' stroke='currentColor' />
      <path d='M20.03 22.2V17' stroke='currentColor' />
    </svg>
  )
}
