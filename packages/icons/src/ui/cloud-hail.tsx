...
export const IconCloudHail: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      <path
        ...
        fill='currentColor'
      />
      <path d='M8.77 14.68v1.89' stroke='currentColor' />
      <path d='M12.6 13.89v1.89' stroke='currentColor' />
      <path d='M15.9 15.42v1.89' stroke='currentColor' />
      ...
      />
      <path
        d='M8.75 19.24a.43.43 0 1 1 0 .85.43.43 0 0 1 0-.85'
        fill='currentColor'
        stroke='currentColor'
      />
      <path
        d='M12.58 18.36a.43.43 0 1 1 0 .85.43.43 0 0 1 0-.85'
        fill='currentColor'
        stroke='currentColor'
      />
      <path
        d='M15.9 20.1a.42.42 0 1 1 0 .85.42.42 0 0 1 0-.84'
        fill='currentColor'
        stroke='currentColor'
      />
    </svg>
