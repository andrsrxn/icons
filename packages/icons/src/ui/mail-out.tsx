...
export const IconMailOut: Icon = ({
  ...
  return (
    <svg
      ...
      />
      <path
        d='m22.52 18.81-.06.07c-1.34 1.33-2 2-2.83 2s-1.5-.67-2.83-2l-.07-.07'
        stroke='currentColor'
      />
      <path d='M19.63 14.34v6.53' stroke='currentColor' />
    </svg>
  )
}
