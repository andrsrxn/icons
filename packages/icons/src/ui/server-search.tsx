...
export const IconServerSearch: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      data-slot='icon-ui-server-search'
      ...
      <path
        opacity='.2'
        d='M4.84 21.23c-.98 0-1.48 0-1.86-.17a2 2 0 0 1-1.03-1.03c-.17-.38-.17-.88-.17-1.86s0-1.48.17-1.86a2 2 0 0 1 1.03-1.03c.38-.17.88-.17 1.86-.17h11.43l-.57 1.75c-.2.6-.3.9-.3 1.21s.09.61.27 1.21l.6 1.95z'
        fill='currentColor'
      />
      <rect
        x='1.78'
      ...
      <path
        ...
        stroke='currentColor'
      />
      <path d='m20.57 20.43 1.81 1.8' stroke='currentColor' />
      <path d='M21.44 18.02a3.1 3.1 0 0 1-3.1 3.1 3.1 3.1 0 1 1 3.1-3.1' stroke='currentColor' />
    </svg>
  )
}
