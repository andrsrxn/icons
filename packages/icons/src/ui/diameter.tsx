...
export const IconDiameter: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      <path
        ...
        stroke='currentColor'
      />
      <path d='M10.28 12H5.27' stroke='currentColor' />
      <path
        d='m6.92 14.46-.34-.34c-1-1-1.5-1.5-1.5-2.12s.5-1.12 1.5-2.12l.34-.34'
        stroke='currentColor'
      />
