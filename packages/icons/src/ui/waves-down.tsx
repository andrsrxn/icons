...
export const IconWavesDown: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      <path
        ...
        stroke='currentColor'
      />
      <path d='M12 3.55v5.8' stroke='currentColor' />
      <path
        d='m15.12 7.46-.29.29c-1.33 1.33-2 2-2.83 2s-1.5-.67-2.83-2l-.29-.29'
        stroke='currentColor'
      />
    </svg>
  )
