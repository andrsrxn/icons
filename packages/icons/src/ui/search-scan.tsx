...
export const IconSearchScan: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      <path
        ...
        stroke='currentColor'
      />
      <path d='M14.29 14.25 17 16.97' stroke='currentColor' />
      <path
        d='M15.5 11.29a4.24 4.24 0 0 1-4.25 4.25 4.25 4.25 0 1 1 4.26-4.25'
        stroke='currentColor'
      />
    </svg>
  )
