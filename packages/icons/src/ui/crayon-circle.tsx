...
export const IconCrayonCircle: Icon = ({
  ...
  return (
    <svg
      ...
      <path
        opacity='.2'
        d='M17.19 14.22c.27.91.41 1.37.26 1.71a1 1 0 0 1-.25.34c-.28.25-.76.25-1.71.25h-6.1c-.9 0-1.36 0-1.64-.24a1 1 0 0 1-.25-.32c-.16-.33-.05-.77.17-1.65.14-.56.2-.84.39-1.03a1 1 0 0 1 .23-.18c.23-.13.52-.13 1.1-.13h6.1c.55 0 .82 0 1.05.12l.22.16c.18.18.26.45.43.97'
        fill='currentColor'
      />
    </svg>
  )
