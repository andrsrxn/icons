...
export const IconDatabaseMove: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      data-slot='icon-ui-database-move'
      ...
      <path d='M3.12 18.83c0 1.87 3.98 3.38 8.88 3.38q1.01 0 1.92-.15' stroke='currentColor' />
      <path d='M3.12 5.23v13.38' stroke='currentColor' />
      <path d='M20.88 5.23v6.73' stroke='currentColor' />
      <path
        d='M20.44 16.87c1.2 1.21 1.81 1.82 1.86 2.56v.29c-.05.74-.65 1.35-1.86 2.56'
        stroke='currentColor'
      />
      <path d='M17 19.58h5.06' stroke='currentColor' />
    </svg>
  )
}
