...
export const IconUnfoldHorizontal: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      data-slot='icon-ui-unfold-horizontal'
      ...
      {...props}>
      <path d='M15.77 12h5.97' stroke='currentColor' />
      <path
        d='m19.8 15.2.38-.37c1.33-1.33 2-2 2-2.83s-.67-1.5-2-2.83l-.38-.38'
        stroke='currentColor'
      />
      <path d='M8.23 12H2.26' stroke='currentColor' />
      <path
