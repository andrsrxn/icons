...
export const IconDatabaseX: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      <path
        d='M3.12 18.83c0 1.87 3.98 3.38 8.88 3.38.68 0 1.15-.02 1.7-.09'
        stroke='currentColor'
      />
      <path d='M3.12 5.74V18.6' stroke='currentColor' />
      <path d='M20.88 5.23v6.73' stroke='currentColor' />
      <path d='m17.84 21.87 4.39-4.4' stroke='currentColor' />
      <path d='m22.23 21.87-4.4-4.39' stroke='currentColor' />
    </svg>
  )
}
