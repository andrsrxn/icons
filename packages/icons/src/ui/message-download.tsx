...
export const IconMessageDownload: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      data-slot='icon-ui-message-download'
      ...
      <path
        ...
        stroke='currentColor'
      />
      <path d='M12.57 7.39v8.11' stroke='currentColor' />
      <path
        d='m16.31 13.63-.91.92c-1.34 1.33-2 2-2.83 2s-1.5-.67-2.83-2l-.92-.92'
        stroke='currentColor'
      />
    </svg>
  )
