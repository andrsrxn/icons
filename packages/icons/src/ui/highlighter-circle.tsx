...
export const IconHighlighterCircle: Icon = ({
  ...
  return (
    <svg
      ...
      <path
        opacity='.2'
        d='M17.22 14.77c.27.9.4 1.36.25 1.7a1 1 0 0 1-.25.33c-.28.25-.75.25-1.7.25H9.6c-.9 0-1.35 0-1.63-.23a1 1 0 0 1-.25-.32c-.17-.33-.06-.77.15-1.64.14-.57.21-.85.4-1.05a1 1 0 0 1 .23-.18c.23-.13.52-.13 1.1-.13h5.9c.56 0 .84 0 1.06.12a1 1 0 0 1 .23.17c.18.18.26.44.42.98'
        fill='currentColor'
      />
    </svg>
  )
