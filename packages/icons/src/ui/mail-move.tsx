...
export const IconMailMove: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      />
      <path
        d='M22.25 11.04V10c0-2.83 0-4.24-.88-5.12S19.07 4 16.25 4h-8.5c-2.83 0-4.24 0-5.12.88s-.88 2.3-.88 5.12v4c0 2.83 0 4.24.88 5.12s2.3.88 5.12.88h4.38'
        stroke='currentColor'
      />
      <path
      ...
      />
      <path
        d='m20.27 20.6.06-.07c1.33-1.33 2-2 2-2.82 0-.83-.66-1.5-2-2.84l-.06-.06'
        stroke='currentColor'
      />
      <path d='M15.56 17.7h6.77' stroke='currentColor' />
    </svg>
  )
}
