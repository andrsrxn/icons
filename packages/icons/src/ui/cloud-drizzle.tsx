...
export const IconCloudDrizzle: Icon = ({
  size = 24,
  strokeWidth = 1.5,
  className,
  ...
  return (
    <svg
      ...
      data-slot='icon-ui-cloud-drizzle'
      ...
      <path
        ...
        stroke='currentColor'
      />
      <path d='M12.24 14.03v-.96' stroke='currentColor' />
      <path d='M12.24 17.4v-.96' stroke='currentColor' />
      <path d='M8.7 18.9v-.95' stroke='currentColor' />
      <path d='M8.7 15.42v-.96' stroke='currentColor' />
      <path d='M15.68 16.22v-.96' stroke='currentColor' />
      <path d='M15.68 19.69v-.96' stroke='currentColor' />
    </svg>
  )
}
