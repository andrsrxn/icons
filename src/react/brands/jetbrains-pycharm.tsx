...
export const IconBrandJetbrainsPyCharm: BrandIcon = ({ className, ...props }: BrandIconProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    aria-label='JetBrains PyCharm'
    ...
    <path fill='url(#pycharm__a)' d='m71.81 19.65 28.05 23.33-10.1 20.55-16.91-4.69H58.22z' />
    <path
      fill='url(#pycharm__b)'
      d='m43.55 34.8-5.43 28.73-.52 9.76-13.69 5.93L4.5 81.31l5.89-62.07L45.56 4.5l21.67 14.21z'
    />
    <path fill='url(#pycharm__c)' d='m43.55 34.8 2.64 55.36-8.77 10.34L4.5 81.31l27.03-40.28z' />
