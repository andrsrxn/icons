...
export const IconBrandSurrealDB: BrandIcon = ({ className, size, ...props }: BrandIconProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    aria-label='SurrealDB'
    ...
    {...props}>
    <defs>
      <linearGradient id='surrealdb__a' x1='31.047%' x2='68.957%' y1='11.705%' y2='88.303%'>
