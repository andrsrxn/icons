...
export const IconBrandSteam: BrandIcon = ({ className, size = 24, ...props }: BrandIconProps) => (
  <svg
    ...
    fill='#fff'
    {...props}>
    <use xlinkHref='#steam__B' x='.5' y='.5' />
    <defs>
      <linearGradient id='steam__A' x2='50%' x1='50%' y2='100%' y1='0%'>
