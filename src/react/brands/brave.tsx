...
export const IconBrandBrave: BrandIcon = ({ className, size = 24, ...props }: BrandIconProps) => (
  <svg
    ...
    {...props}>
    <defs>
      <linearGradient id='brave__linearGradient-1' x1='0%' x2='100.097%' y1='50.018%' y2='50.018%'>
        <stop offset='0%' stopColor='#fff' />
        <stop offset='14.13%' stopColor='#fff' stopOpacity='.958' />
        <stop offset='100%' stopColor='#fff' stopOpacity='.7' />
      </linearGradient>
      <linearGradient id='brave__linearGradient-2' x1='-.039%' x2='100%' y1='49.982%' y2='49.982%'>
