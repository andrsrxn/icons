...
export const IconBrandEthereum: BrandIcon = ({ className, size, ...props }: BrandIconProps) => (
  <svg
    ...
    <g fill='none' fillRule='evenodd'>
      ...
      <use fill='url(#eth__eth-c)' style={{ mixBlendMode: 'soft-light' }} xlinkHref='#eth__eth-b' />
