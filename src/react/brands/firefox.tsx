...
export const IconBrandFirefox: BrandIcon = ({ className, size = 24, ...props }: BrandIconProps) => (
  <svg
    ...
    <path
      fill='url(#firefox__i)'
      d='M174.654 88.838a69.8 69.8 0 0 1 11.904 15.542 27 27 0 0 1 1.921 1.574c29.056 26.784 13.832 64.646 12.698 67.341 23.603-19.447 38.688-48.205 34.155-77.89-14.497-36.142-39.069-50.708-59.137-82.426a155 155 0 0 1-3.019-4.907 41 41 0 0 1-1.412-2.645 23.3 23.3 0 0 1-1.912-5.076.33.33 0 0 0-.291-.331.5.5 0 0 0-.241 0c-.016 0-.043.03-.063.037s-.063.036-.092.049c-4.957 2.351-34.35 48.893 5.489 88.732'
    />
    <path
      fill='url(#firefox__j)'
