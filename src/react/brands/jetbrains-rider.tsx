...
export const IconBrandJetBrainsRider: BrandIcon = ({ className, ...props }: BrandIconProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    aria-label='JetBrains Rider'
    ...
    {...props}>
    <defs>
      <linearGradient id='rider__a' x1='90.8%' x2='-19.1%' y1='81.8%' y2='19%'>
        <stop offset='0%' stopColor='#DD1265' />
        <stop offset='48%' stopColor='#DD1265' />
        <stop offset='94%' stopColor='#FDB60D' />
      </linearGradient>
      <linearGradient id='rider__b' x1='36%' x2='53.7%' y1='7.3%' y2='93%'>
        <stop offset='14%' stopColor='#087CFA' />
        <stop offset='48%' stopColor='#DD1265' />
        <stop offset='96%' stopColor='#087CFA' />
      </linearGradient>
      <linearGradient id='rider__c' x1='39.5%' x2='56.9%' y1='11.4%' y2='91.7%'>
