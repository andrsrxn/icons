...
export const IconBrandYarn: BrandIcon = ({ className, size = 24, ...props }: BrandIconProps) => (
  <svg
    ...
    viewBox='0 0 518 518'
    {...props}>
    <path fill='#2c8ebb' d='M259 0c143 0 259 116 259 259S402 518 259 518 0 402 0 259 116 0 259 0' />
    <path
      fill='#fff'
