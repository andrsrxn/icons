...
export const IconBrandTanstack: BrandIcon = ({ className, size, ...props }: BrandIconProps) => (
  <svg
    ...
    <g fill='none' fillRule='evenodd' transform='translate(9 8)'>
      ...
      <g mask='url(#tanstack__c)'>
        <path
          ...
          transform='rotate(155 122.6 66.59)scale(1 -1)'
        />
        <g stroke='#2f8a00'>
          <path
        ...
        <path
          ...
          transform='rotate(-171 224.84 164.654)scale(1 -1)'
        />
        <path
          fill='#d8d8d8'
          stroke='#fff'
