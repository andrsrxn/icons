...
export const IconBrandGemini: BrandIcon = ({ className, size = 24, ...props }: BrandIconProps) => (
  <svg
    ...
    <g mask='url(#gemini__a)'>
      ...
      <g filter='url(#gemini__e)'>
        <path fill='#fa4340' d='M194 10.5C172 82.5 65.5 134.333 22.5 135L144-66z' />
      </g>
      <g filter='url(#gemini__f)'>
        <path fill='#fa4340' d='M190.5-12.5C168.5 59.5 62 111.333 19 112L140.5-89z' />
      </g>
      <g filter='url(#gemini__g)'>
        <path fill='#14bb69' d='M194.5 279.5C172.5 207.5 66 155.667 23 155l121.5 201z' />
      </g>
      <g filter='url(#gemini__h)'>
        <path fill='#14bb69' d='M196.5 320.5C174.5 248.5 68 196.667 25 196l121.5 201z' />
      </g>
    </g>
    <defs>
      <filter
