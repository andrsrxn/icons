...
export const IconBrandJetBrains: BrandIcon = ({ className, size, ...props }: BrandIconProps) => (
  <svg
    ...
    {...props}>
    <defs>
      <linearGradient x1='25.2%' y1='43.3%' x2='99.2%' y2='67.4%' id='jetbrains__a'>
        <stop stopColor='#FE2857' offset='21%' />
        <stop stopColor='#293896' offset='100%' />
      </linearGradient>
      <linearGradient x1='2.3%' y1='77.1%' x2='90.7%' y2='24.1%' id='jetbrains__b'>
        <stop stopColor='#FE2857' offset='0%' />
        <stop stopColor='#FE2857' offset='1%' />
        <stop stopColor='#FF318C' offset='86%' />
      </linearGradient>
      <linearGradient x1='6.3%' y1='13.9%' x2='94.6%' y2='87.7%' id='jetbrains__c'>
        <stop stopColor='#FF318C' offset='2%' />
        <stop stopColor='#FE2857' offset='21%' />
        <stop stopColor='#FDB60D' offset='86%' />
      </linearGradient>
      <linearGradient x1='91.1%' y1='27.7%' x2='2%' y2='68.6%' id='jetbrains__d'>
