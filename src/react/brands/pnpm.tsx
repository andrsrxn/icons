...
export const IconBrandPNPM: BrandIcon = ({ className, size = 24, ...props }: BrandIconProps) => (
  <svg
    ...
    <g>
      <g>
        <use xlinkHref='#pnpm__arNRoK435' opacity='1' fill='#f9ad00' fillOpacity='1' />
      </g>
      <g>
        <use xlinkHref='#pnpm__a3H2WU7Px' opacity='1' fill='#f9ad00' fillOpacity='1' />
      </g>
      <g>
        <use xlinkHref='#pnpm__b1DInM56vl' opacity='1' fill='#f9ad00' fillOpacity='1' />
      </g>
      <g>
        <use xlinkHref='#pnpm__a7LFlgQIwu' opacity='1' fill='#f9ad00' fillOpacity='1' />
      </g>
      <g>
        <use
          xlinkHref='#pnpm__amwLiZcuo'
          opacity='1'
          fill='var(--ui-icon-fill-pnpm)'
          fillOpacity='1'
        />
      </g>
      <g>
