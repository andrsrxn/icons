...
export const IconBrandMicrosoftWord: BrandIcon = ({ className, ...props }: BrandIconProps) => (
  <svg
    ...
    <defs>
      ...
      <radialGradient
        ...
        fx='-730.97'
        fy='806.4'
        gradientTransform='rotate(133.54 -23021.96 -24387.349)scale(29.36 -72.31)skewX(.03)'
        gradientUnits='userSpaceOnUse'>
        <stop offset='.14' stopColor='#d471ff' />
        <stop offset='.83' stopOpacity='0' stopColor='#509df5' />
      </radialGradient>
      <radialGradient
        ...
        gradientUnits='userSpaceOnUse'>
        <stop offset='.28' stopOpacity='0' stopColor='#4f006f' />
      ...
      <radialGradient
        ...
        <stop offset='.54' stopOpacity='0' stopColor='#e4a7fe' />
      </radialGradient>
      <radialGradient
        ...
        fx='-675.64'
        fy='797.48'
        gradientTransform='rotate(225 3955.88 12306.641)scale(-22.62 22.62)skewY(-.01)'
        gradientUnits='userSpaceOnUse'>
      ...
      <radialGradient
        ...
        gradientUnits='userSpaceOnUse'>
        <stop offset='.59' stopOpacity='0' stopColor='#2763e5' />
    ...
    <path
      d='m69.43 376.25 194.4-237.36L486 293.13v158.26c0 26.85-21.76 48.61-48.6 48.61H152.74c-46.01 0-83.31-37.31-83.31-83.33z'
    ...
    />
    <path
      d='M69.43 83.33C69.43 37.31 106.73 0 152.74 0H437.4C464.24 0 486 21.76 486 48.61v69.44c0 26.85-21.76 48.61-48.6 48.61H152.74c-46.01 0-83.31 37.31-83.31 83.33z'
