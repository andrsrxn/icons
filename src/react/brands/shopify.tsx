...
export const IconBrandShopify: BrandIcon = ({ className, size = 24, ...props }: BrandIconProps) => (
  <svg
    ...
    <path
      fill='#5e8e3e'
      d='M94.8 22.9c-.5 0-9.3-.2-9.3-.2s-7.4-7.2-8.1-7.9c-.3-.3-.6-.4-1-.5V124l33.1-8.2S96 24.5 95.9 23.8c-.1-.5-.6-.9-1.1-.9'
    />
    <path
      fill='#fff'
