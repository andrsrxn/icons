...
export const IconBrandJetBrainsRubyMine: BrandIcon = ({ className, ...props }: BrandIconProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    aria-label='JetBrains RubyMine'
    ...
    <path
      fill='url(#rubymine__a)'
      d='m83.34 4.5-27.47 9.84L34.22 4.5l-7.13 17.96h-4.61v53.02l66.67.58 10.35-52.8z'
    />
    <path fill='url(#rubymine__b)' d='m82.52 38.95-43.87-26 43.87 51.42z' />
    <path
      fill='url(#rubymine__c)'
