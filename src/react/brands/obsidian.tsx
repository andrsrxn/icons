...
export const IconBrandObsidian: BrandIcon = ({ className, size, ...props }: BrandIconProps) => (
  <svg
    ...
    <defs>
      <radialGradient
        ...
        <stop offset='0%' stopOpacity='.4' stopColor='#FFF' />
      ...
      <radialGradient
        ...
        <stop offset='0%' stopOpacity='.6' stopColor='#FFF' />
      ...
      <radialGradient
        ...
        <stop offset='0%' stopOpacity='.8' stopColor='#FFF' />
        <stop offset='100%' stopOpacity='.4' stopColor='#FFF' />
      </radialGradient>
      <radialGradient
        id='obsidian__d'
        cx='71.813%'
        ...
        <stop offset='0%' stopOpacity='.3' stopColor='#FFF' />
      ...
      <radialGradient
        ...
        <stop offset='100%' stopOpacity='.2' stopColor='#FFF' />
      </radialGradient>
      <radialGradient
        id='obsidian__f'
        cx='-9.431%'
        ...
        <stop offset='0%' stopOpacity='.2' stopColor='#FFF' />
        <stop offset='100%' stopOpacity='.4' stopColor='#FFF' />
      </radialGradient>
      <radialGradient
        id='obsidian__g'
        ...
        <stop offset='100%' stopOpacity='.3' stopColor='#FFF' />
      </radialGradient>
      <radialGradient
        id='obsidian__h'
        cx='99.348%'
        ...
        <stop offset='0%' stopOpacity='.2' stopColor='#FFF' />
        <stop offset='50%' stopOpacity='.2' stopColor='#FFF' />
        <stop offset='100%' stopOpacity='.3' stopColor='#FFF' />
      </radialGradient>
    </defs>
    <path
