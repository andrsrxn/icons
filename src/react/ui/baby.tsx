...
export const IconBaby: Icon = ({
  ...
  return (
    <svg
      ...
      <path
        opacity='.2'
        d='M11.98 19.6c3.44 0 6.35-2.3 7.27-5.45 0 0 1.38-.23 1.38-2.14 0-1.82-1.4-2.16-1.4-2.16a7.57 7.57 0 0 0-14.5 0s-1.35.39-1.35 2.16c0 1.84 1.33 2.13 1.33 2.13a7.6 7.6 0 0 0 7.27 5.46'
        fill='currentColor'
      />
      <path
        d='m9.95 6.76-.69.29zm4.48 1.38a.75.75 0 1 0-.55-1.4l.28.7zm-3.53-3.6-.42-.63-.03.02-.26.21a4 4 0 0 0-.55.6 2.3 2.3 0 0 0-.38 2.3l.7-.28.68-.3q-.15-.37.2-.83a2 2 0 0 1 .49-.48zm-.95 2.22-.69.29c.63 1.49 2.17 1.63 3.17 1.55a8 8 0 0 0 1.98-.45h.01v-.01l-.26-.7-.28-.7-.11.04a7 7 0 0 1-1.46.32q-1.34.13-1.67-.63z'
        fill='currentColor'
      />
      <path
