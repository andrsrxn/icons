...
export const IconBinary: Icon = ({
  ...
  return (
    <svg
      ...
      <path
        d='M3.74 5.69a1.98 1.98 0 0 1 3.95 0v3a1.98 1.98 0 1 1-3.95 0zm12.57 0a1.98 1.98 0 1 1 3.95 0v3a1.98 1.98 0 1 1-3.95 0zm-6.29 9.61a1.98 1.98 0 0 1 3.96 0v2.99a1.98 1.98 0 1 1-3.96 0z'
        fill='currentColor'
        opacity='.2'
      />
      <path
