...
export const IconDiceThree: Icon = ({
  ...
  return (
    <svg
      ...
      />
      <path
        d='M12.65 11.95a.65.65 0 1 1-1.3 0 .65.65 0 0 1 1.3 0M8.6 16.1a.65.65 0 1 1-1.3 0 .65.65 0 0 1 1.3 0m8.06-8.45a.65.65 0 1 1-1.3 0 .65.65 0 0 1 1.3 0'
        fill='currentColor'
      />
      <path
      ...
      />
      <path
        d='M12.65 11.95a.65.65 0 1 1-1.3 0 .65.65 0 0 1 1.3 0ZM8.6 16.1a.65.65 0 1 1-1.3 0 .65.65 0 0 1 1.3 0Zm8.06-8.45a.65.65 0 1 1-1.3 0 .65.65 0 0 1 1.3 0Z'
        stroke='currentColor'
        strokeWidth='1.5'
        strokeLinecap='round'
      />
