...
export const IconIsland: Icon = ({
  ...
  return (
    <svg
      ...
      />
      <path
        d='M15.27 7.24a.75.75 0 0 0-1 1.1l.5-.55zm.62 4.16a.75.75 0 0 0 1.5.03l-.75-.01zm-1.12-3.6-.5.55.13.12.34.37c.28.32.6.72.78 1.11l.68-.33.67-.33a7 7 0 0 0-1.58-2.04h-.01v-.01zm1.43 1.82-.68.33a4 4 0 0 1 .37 1.44v.01l.75.02.75.01v-.2q0-.18-.05-.47-.09-.6-.47-1.47z'
        fill='currentColor'
      />
      <path
