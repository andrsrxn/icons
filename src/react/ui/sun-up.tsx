...
export const IconSunUp: Icon = ({
  ...
  return (
    <svg
      ...
      />
      <path
        d='M6.64 17.46a5.33 5.33 0 1 1 10.66 0m-.47-7.33 1.48-1.47m1.41 5.44 2.01-.54m-17.45.54-2.01-.54m4.9-3.43L5.7 8.67m4-3.11c.8-.8 1.2-1.2 1.66-1.35a2 2 0 0 1 1.22 0c.46.14.86.54 1.66 1.35m-2.27 3.31V4.2'
        stroke='currentColor'
