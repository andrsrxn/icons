...
export const IconCopy: Icon = ({
  ...
  return (
    <svg
      ...
      <path
        opacity='.2'
        d='M3.51 12.67c0-1.89 0-2.83.59-3.42.58-.58 1.53-.58 3.41-.58h3.67c1.89 0 2.83 0 3.42.58.58.59.58 1.53.58 3.42v3.67c0 1.88 0 2.83-.58 3.41-.59.59-1.53.59-3.42.59H7.51c-1.88 0-2.83 0-3.41-.59-.59-.58-.59-1.53-.59-3.41z'
        fill='currentColor'
      />
      <path
