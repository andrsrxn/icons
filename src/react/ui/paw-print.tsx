...
export const IconPawPrint: Icon = ({
  ...
  return (
    <svg
      ...
      <path
        opacity='.2'
        d='m7.2 14.19 1.21-.92c1.15-.86 1.72-1.3 2.34-1.5a4 4 0 0 1 2.54 0c.61.2 1.19.64 2.33 1.5l1.22.92a2.95 2.95 0 0 1-2.76 5.13l-.86-.31a3.6 3.6 0 0 0-2.4 0l-.88.3A2.95 2.95 0 0 1 7.2 14.2'
        fill='currentColor'
      />
      <ellipse
        opacity='.2'
