...
export const IconBug: Icon = ({
  ...
  return (
    <svg
      ...
      <path
        opacity='.2'
        d='M6.59 12.5c0-1.11 0-1.67.11-2.13a4 4 0 0 1 2.96-2.95c.46-.11 1.01-.11 2.13-.11h.42a11 11 0 0 1 2.13.1 4 4 0 0 1 2.96 2.96c.11.46.11 1.02.11 2.13v2.4a5.4 5.4 0 1 1-10.82 0z'
        fill='currentColor'
      />
      <path
