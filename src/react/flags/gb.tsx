...
export const IconFlagGB: FlagIcon = ({ className, ...props }: FlagIconProps) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gb-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gb-linearGradient-2'>
          <stop stopColor='#0A17A7' offset='0%' />
          <stop stopColor='#030E88' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gb-linearGradient-3'>
          <stop stopColor='#E6273E' offset='0%' />
          <stop stopColor='#CF152B' offset='100%' />
        </linearGradient>
      </defs>
      <g id='gb-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='gb-GB'>
          <rect
            id='gb-FlagBackground'
            fill='url(#gb-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          />
          <polygon
            id='gb-Rectangle-2-Copy-3'
            fill='url(#gb-linearGradient-3)'
