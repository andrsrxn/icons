...
export const IconFlagTR: FlagIcon = ({ className, ...props }: FlagIconProps) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='tr-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='tr-linearGradient-2'>
          <stop stopColor='#E92434' offset='0%' />
          <stop stopColor='#E11324' offset='100%' />
        </linearGradient>
      </defs>
      <g id='tr-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='tr-TR'>
          <rect
            id='tr-FlagBackground'
            fill='url(#tr-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
