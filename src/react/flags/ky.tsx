...
export const IconFlagKY: FlagIcon = ({ className, ...props }: FlagIconProps) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='ky-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='ky-linearGradient-2'>
          <stop stopColor='#07319C' offset='0%' />
          <stop stopColor='#00247E' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='ky-linearGradient-3'>
          <stop stopColor='#DB1E36' offset='0%' />
          <stop stopColor='#D51931' offset='100%' />
        </linearGradient>
        <path d='M0,3.5 L0,0 L5,0 L5,3.5 C5,6 2.5,7 2.5,7 C2.5,7 0,6 0,3.5 Z' id='ky-path-4' />
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='ky-linearGradient-6'>
          <stop stopColor='#125FBA' offset='0%' />
          <stop stopColor='#0C50A1' offset='100%' />
        </linearGradient>
      </defs>
      <g id='ky-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='ky-KY'>
          <rect
            id='ky-FlagBackground'
            fill='url(#ky-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          />
          <ellipse id='ky-Oval-180' fill='#FAD051' cx='15.5' cy='4' rx='1.5' ry='1' />
          <g id='ky-Rectangle-1105' transform='translate(13.000000, 4.000000)'>
            <mask id='ky-mask-5' fill='white'>
              <use xlinkHref='#ky-path-4' />
            </mask>
            <use id='ky-Mask' fill='url(#ky-linearGradient-1)' xlinkHref='#ky-path-4' />
            <polygon
              id='ky-Rectangle-1106'
              fill='#CF142C'
              mask='url(#ky-mask-5)'
