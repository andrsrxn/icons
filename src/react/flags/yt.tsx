...
export const IconFlagYT: FlagIcon = ({ className, ...props }: FlagIconProps) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='yt-linearGradient-1'>
        ...
        <path
          ...
          id='yt-path-2'
        />
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='yt-linearGradient-4'>
          <stop stopColor='#1B2CA9' offset='0%' />
          <stop stopColor='#132294' offset='100%' />
        </linearGradient>
        <rect id='yt-path-5' x='0' y='0' width='5' height='3' />
        <filter
          x='-15.0%'
          y='-25.0%'
          width='130.0%'
        ...
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='yt-linearGradient-7'>
          <stop stopColor='#E6402C' offset='0%' />
          <stop stopColor='#D1321F' offset='100%' />
        </linearGradient>
        <rect id='yt-path-8' x='0' y='3' width='5' height='4' />
        <filter
          x='-15.0%'
          y='-18.8%'
          width='130.0%'
        ...
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='yt-linearGradient-10'>
          <stop stopColor='#D0D0D0' offset='0%' />
          <stop stopColor='#C4C4C4' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='yt-linearGradient-11'>
          <stop stopColor='#262626' offset='0%' />
          <stop stopColor='#0D0D0D' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='yt-linearGradient-12'>
          <stop stopColor='#F7E04B' offset='0%' />
          <stop stopColor='#EAD135' offset='100%' />
        </linearGradient>
      </defs>
      <g id='yt-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='yt-YT'>
          <rect
            id='yt-FlagBackground'
            fill='url(#yt-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          />
          <g id='yt-Group-2' transform='translate(8.000000, 4.000000)'>
            <mask id='yt-mask-3' fill='white'>
              <use xlinkHref='#yt-path-2' />
            </mask>
            <g id='yt-Rectangle-1413'>
              <use fill='#D8D8D8' fillRule='evenodd' xlinkHref='#yt-path-2' />
              <path
                stroke='#979797'
                strokeWidth='1'
            ...
            <g id='yt-Rectangle-1414' mask='url(#yt-mask-3)'>
              <use fill='black' fillOpacity='1' filter='url(#yt-filter-6)' xlinkHref='#yt-path-5' />
              <use fill='url(#yt-linearGradient-4)' fillRule='evenodd' xlinkHref='#yt-path-5' />
            </g>
            <g id='yt-Rectangle-1414-Copy' mask='url(#yt-mask-3)'>
              <use fill='black' fillOpacity='1' filter='url(#yt-filter-9)' xlinkHref='#yt-path-8' />
              <use fill='url(#yt-linearGradient-7)' fillRule='evenodd' xlinkHref='#yt-path-8' />
            </g>
          </g>
          <g id='yt-Group' transform='translate(14.000000, 3.000000)'>
            <path
              ...
              id='yt-Rectangle-1411'
              fill='url(#yt-linearGradient-10)'
            />
            <circle
              id='yt-Oval-280'
              fillOpacity='0.3'
              fill='url(#yt-linearGradient-11)'
              cx='1.75'
              cy='1.75'
              r='1'
            />
