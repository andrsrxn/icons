...
export const IconFlagZM = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='zm-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='100%' x2='50%' y2='3.061617e-15%' id='zm-linearGradient-2'>
          <stop stopColor='#2A8815' offset='0%' />
          <stop stopColor='#35A51D' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='zm-linearGradient-3'>
          <stop stopColor='#EF8A34' offset='0%' />
          <stop stopColor='#EC7E21' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='zm-linearGradient-4'>
          <stop stopColor='#F48D36' offset='0%' />
          <stop stopColor='#EC7E21' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='zm-linearGradient-5'>
          <stop stopColor='#262626' offset='0%' />
          <stop stopColor='#0D0D0D' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='zm-linearGradient-6'>
          <stop stopColor='#EC322B' offset='0%' />
          <stop stopColor='#DB261F' offset='100%' />
        </linearGradient>
      </defs>
      <g id='zm-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='zm-ZM'>
          <rect
            id='zm-FlagBackground'
            fill='url(#zm-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          <path
            ...
            id='zm-Combined-Shape'
            fill='url(#zm-linearGradient-3)'
          />
          <rect
            id='zm-Rectangle-1349'
            fill='url(#zm-linearGradient-4)'
            x='18'
            y='6'
            width='3'
            height='9'
          />
          <rect
            id='zm-Rectangle-1349-Copy'
            fill='url(#zm-linearGradient-5)'
            x='15'
            y='6'
            width='3'
            height='9'
          />
          <rect
            id='zm-Rectangle-1349-Copy-2'
            fill='url(#zm-linearGradient-6)'
            x='12'
            y='6'
            width='3'
            height='9'
