...
export const IconFlagCK: FlagIcon = ({ className, ...props }: FlagIconProps) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='ck-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='ck-linearGradient-2'>
          <stop stopColor='#0A17A7' offset='0%' />
          <stop stopColor='#030E88' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='ck-linearGradient-3'>
          <stop stopColor='#DB1E36' offset='0%' />
          <stop stopColor='#D51931' offset='100%' />
        </linearGradient>
      </defs>
      <g id='ck-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='ck-CK'>
          <rect
            id='ck-FlagBackground'
            fill='url(#ck-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
