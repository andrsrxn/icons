...
export const IconFlagMX = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='mx-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='mx-linearGradient-2'>
          <stop stopColor='#E3283E' offset='0%' />
          <stop stopColor='#CC162C' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='mx-linearGradient-3'>
          <stop stopColor='#128A60' offset='0%' />
          <stop stopColor='#0B6848' offset='100%' />
        </linearGradient>
      </defs>
      <g id='mx-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='mx-MX'>
          <rect
            id='mx-FlagBackground'
            fill='url(#mx-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          />
          <rect id='mx-Mask' fill='url(#mx-linearGradient-2)' x='10' y='0' width='11' height='15' />
          <rect
            id='mx-Rectangle-2'
            fill='url(#mx-linearGradient-3)'
            x='0'
            y='0'
            width='7'
            height='15'
          ...
          <path
            ...
            fillRule='nonzero'
          />
          <ellipse id='mx-Oval-5' fill='#C59262' cx='10.5' cy='6.5' rx='1' ry='1.5' />
        </g>
      </g>
    </svg>
  )
