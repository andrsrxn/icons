...
export const IconFlagBB = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <g id='bb-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='bb-BB'>
          <rect
            id='bb-FlagBackground'
            fill='url(#bb-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          />
          <rect
            id='bb-Rectangle-2-Copy'
            fill='url(#bb-linearGradient-4)'
            x='7'
            y='0'
            width='7'
            height='15'
          ...
          <path
            ...
            id='bb-Combined-Shape'
            fill='url(#bb-linearGradient-5)'
          />
        </g>
      </g>
    </svg>
