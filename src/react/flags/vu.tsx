...
export const IconFlagVU: FlagIcon = ({ className, ...props }: FlagIconProps) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='vu-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='vu-linearGradient-2'>
          <stop stopColor='#27AB53' offset='0%' />
          <stop stopColor='#219447' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='vu-linearGradient-3'>
          <stop stopColor='#EC2547' offset='0%' />
          <stop stopColor='#CE1A39' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='vu-linearGradient-4'>
          <stop stopColor='#262626' offset='0%' />
          <stop stopColor='#0D0D0D' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='vu-linearGradient-5'>
          <stop stopColor='#FFD449' offset='0%' />
          <stop stopColor='#FDCD34' offset='100%' />
        </linearGradient>
      </defs>
      <g id='vu-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='vu-VU'>
          <rect
            id='vu-FlagBackground'
            fill='url(#vu-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          <path
            ...
            id='vu-Combined-Shape'
            fill='url(#vu-linearGradient-4)'
          />
          <path
