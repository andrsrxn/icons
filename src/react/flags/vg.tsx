...
export const IconFlagVG = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='vg-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='vg-linearGradient-2'>
          <stop stopColor='#07319C' offset='0%' />
          <stop stopColor='#00247E' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='vg-linearGradient-3'>
          <stop stopColor='#008339' offset='0%' />
          <stop stopColor='#00612A' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='vg-linearGradient-4'>
          <stop stopColor='#FFD033' offset='0%' />
          <stop stopColor='#FEC403' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='vg-linearGradient-5'>
          <stop stopColor='#DB1E36' offset='0%' />
          <stop stopColor='#D51931' offset='100%' />
        </linearGradient>
      </defs>
      <g id='vg-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='vg-VG'>
          <rect
            id='vg-FlagBackground'
            fill='url(#vg-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
