...
export const IconFlagMO: FlagIcon = ({ className, ...props }: FlagIconProps) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='mo-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='mo-linearGradient-2'>
          <stop stopColor='#079D7B' offset='0%' />
          <stop stopColor='#01795E' offset='100%' />
        </linearGradient>
      </defs>
      <g id='mo-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='mo-MO'>
          <rect
            id='mo-FlagBackground'
            fill='url(#mo-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          <rect
            id='mo-Rectangle-2'
            fill='url(#mo-linearGradient-2)'
            x='0'
            y='0'
            width='21'
            height='15'
          />
          <g id='mo-Oval-9' transform='translate(6.000000, 2.000000)'>
            <path
