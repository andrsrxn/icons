...
export const IconFlagLK = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='lk-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='lk-linearGradient-2'>
          <stop stopColor='#FFBF19' offset='0%' />
          <stop stopColor='#FFB800' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='lk-linearGradient-3'>
          <stop stopColor='#A52531' offset='0%' />
          <stop stopColor='#8E1F29' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='lk-linearGradient-4'>
          <stop stopColor='#03664F' offset='0%' />
          <stop stopColor='#005642' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='lk-linearGradient-5'>
          <stop stopColor='#FF6816' offset='0%' />
          <stop stopColor='#FF5B01' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='lk-linearGradient-6'>
          <stop stopColor='#FFBF18' offset='0%' />
          <stop stopColor='#FFB800' offset='100%' />
        </linearGradient>
      </defs>
      <g id='lk-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='lk-LK'>
          <rect
            id='lk-FlagBackground'
            fill='url(#lk-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          <path
            ...
            id='lk-Rectangle-1568'
            fill='url(#lk-linearGradient-3)'
          />
          <path
            ...
            id='lk-Rectangle-1568'
            fill='url(#lk-linearGradient-4)'
          />
          <rect
            id='lk-Rectangle-1568'
            fill='url(#lk-linearGradient-5)'
            x='4'
            y='1'
            width='3'
            height='13'
