...
export const IconFlagAO = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='ao-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='ao-linearGradient-2'>
          <stop stopColor='#FF323E' offset='0%' />
          <stop stopColor='#FD0D1B' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='ao-linearGradient-3'>
          <stop stopColor='#262626' offset='0%' />
          <stop stopColor='#0D0D0D' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='ao-linearGradient-4'>
          <stop stopColor='#DD2137' offset='0%' />
          <stop stopColor='#CC162C' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='ao-linearGradient-5'>
          <stop stopColor='#F8D84B' offset='0%' />
          <stop stopColor='#F9D536' offset='100%' />
        </linearGradient>
      </defs>
      <g id='ao-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='ao-AO'>
          <rect
            id='ao-FlagBackground'
            fill='url(#ao-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
