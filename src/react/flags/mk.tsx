...
export const IconFlagMK: FlagIcon = ({ className, ...props }: FlagIconProps) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        ...
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='mk-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='mk-linearGradient-2'>
          <stop stopColor='#E81B26' offset='0%' />
          <stop stopColor='#D00914' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='mk-linearGradient-3'>
      ...
      <g
        ...
        <g id='mk-MK'>
          <rect
            id='mk-FlagBackground'
            fill='url(#mk-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
