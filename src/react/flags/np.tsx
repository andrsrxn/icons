...
export const IconFlagNP: FlagIcon = ({ className, ...props }: FlagIconProps) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='np-linearGradient-1'>
        ...
        <path
          ...
          id='np-path-2'
        />
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='np-linearGradient-4'>
          <stop stopColor='#EE1B44' offset='0%' />
          <stop stopColor='#DD153C' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='np-linearGradient-5'>
      ...
      <g id='np-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='np-NP'>
          <mask id='np-mask-3' fill='white'>
            <use xlinkHref='#np-path-2' />
          </mask>
          <use id='np-Mask' fill='url(#np-linearGradient-1)' xlinkHref='#np-path-2' />
          <g id='np-Mask-Copy' mask='url(#np-mask-3)'>
            <use fill='url(#np-linearGradient-4)' fillRule='evenodd' xlinkHref='#np-path-6' />
            <path
              stroke='url(#np-linearGradient-5)'
              strokeWidth='1'
