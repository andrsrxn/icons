...
export const IconFlagTV = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='tv-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='tv-linearGradient-2'>
          <stop stopColor='#72AFC8' offset='0%' />
          <stop stopColor='#5D98B0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='tv-linearGradient-3'>
          <stop stopColor='#0A17A7' offset='0%' />
          <stop stopColor='#030E88' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='tv-linearGradient-4'>
          <stop stopColor='#DB1E36' offset='0%' />
          <stop stopColor='#D51931' offset='100%' />
        </linearGradient>
      </defs>
      <g id='tv-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='tv-TV'>
          <rect
            id='tv-FlagBackground'
            fill='url(#tv-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          <path
            ...
            id='tv-Combined-Shape'
            fill='#FFCD2F'
          />
          <rect
            id='tv-Mask-Copy-2'
            fill='url(#tv-linearGradient-3)'
            x='0'
            y='0'
            width='9'
            height='7'
