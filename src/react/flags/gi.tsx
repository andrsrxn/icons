...
export const IconFlagGI: FlagIcon = ({ className, ...props }: FlagIconProps) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gi-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gi-linearGradient-2'>
          <stop stopColor='#E71924' offset='0%' />
          <stop stopColor='#D6101B' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gi-linearGradient-3'>
          <stop stopColor='#EA1824' offset='0%' />
          <stop stopColor='#D6101B' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gi-linearGradient-4'>
          <stop stopColor='#262626' offset='0%' />
          <stop stopColor='#0D0D0D' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gi-linearGradient-5'>
          <stop stopColor='#ECCE3E' offset='0%' />
          <stop stopColor='#D9BC2D' offset='100%' />
        </linearGradient>
      </defs>
      <g id='gi-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='gi-GI'>
          <rect
            id='gi-FlagBackground'
            fill='url(#gi-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          />
          <rect
            id='gi-Combined-Shape'
            fill='url(#gi-linearGradient-2)'
            x='0'
            y='10'
            width='21'
            height='5'
