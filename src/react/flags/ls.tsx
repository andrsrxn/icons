...
export const IconFlagLS = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <g id='ls-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='ls-LS'>
          <rect
            id='ls-FlagBackground'
            fill='url(#ls-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
