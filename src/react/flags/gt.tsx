...
export const IconFlagGT = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gt-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gt-linearGradient-2'>
          <stop stopColor='#63AEE3' offset='0%' />
          <stop stopColor='#4998D0' offset='100%' />
        </linearGradient>
      </defs>
      <g id='gt-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='gt-GT'>
          <rect
            id='gt-FlagBackground'
            fill='url(#gt-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          />
          <rect id='gt-Mask' fill='url(#gt-linearGradient-2)' x='10' y='0' width='11' height='15' />
          <rect
            id='gt-Rectangle-2'
            fill='url(#gt-linearGradient-2)'
            x='0'
            y='0'
            width='7'
            height='15'
          ...
          <path
            ...
            fillRule='nonzero'
          />
          <circle id='gt-Oval-5' fill='#DCC26D' cx='10.5' cy='7' r='1' />
        </g>
      </g>
    </svg>
  )
