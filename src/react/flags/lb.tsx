...
export const IconFlagLB: FlagIcon = ({ className, ...props }: FlagIconProps) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <g id='lb-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='lb-LB'>
          <rect
            id='lb-FlagBackground'
            fill='url(#lb-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          <path
            ...
            id='lb-Combined-Shape'
            fill='url(#lb-linearGradient-3)'
          />
        </g>
      </g>
    </svg>
