...
export const IconFlagTC = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='tc-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='tc-linearGradient-2'>
          <stop stopColor='#07319C' offset='0%' />
          <stop stopColor='#00247E' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='tc-linearGradient-3'>
          <stop stopColor='#FFD033' offset='0%' />
          <stop stopColor='#FEC403' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='tc-linearGradient-4'>
          <stop stopColor='#DB1E36' offset='0%' />
          <stop stopColor='#D51931' offset='100%' />
        </linearGradient>
      </defs>
      <g id='tc-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='tc-TC'>
          <rect
            id='tc-FlagBackground'
            fill='url(#tc-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          <path
            ...
            id='tc-Mask'
            fill='url(#tc-linearGradient-3)'
            fillRule='nonzero'
          />
          <ellipse id='tc-Oval-193' fill='#BA5B1F' cx='16.5' cy='6' rx='1' ry='1' />
          <ellipse
            id='tc-Oval-193'
            fill='#FF9F3E'
          ...
          <ellipse
            ...
            ry='1'
          />
          <polygon id='tc-Rectangle-1188' fill='#01A827' points='15 8 15.5 7 16 8 16 9 15 9' />
          <path
