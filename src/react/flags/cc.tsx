...
export const IconFlagCC: FlagIcon = ({ className, ...props }: FlagIconProps) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='cc-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='cc-linearGradient-2'>
          <stop stopColor='#229716' offset='0%' />
          <stop stopColor='#1C7E12' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='cc-linearGradient-3'>
          <stop stopColor='#FFE244' offset='0%' />
          <stop stopColor='#FFDF32' offset='100%' />
        </linearGradient>
      </defs>
      <g id='cc-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='cc-CC'>
          <rect
            id='cc-FlagBackground'
            fill='url(#cc-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          <path
            ...
            id='cc-Combined-Shape'
            fill='url(#cc-linearGradient-3)'
          />
          <polygon
            id='cc-Star-2'
            fill='url(#cc-linearGradient-3)'
