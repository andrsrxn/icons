...
export const IconFlagAW = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='aw-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='aw-linearGradient-2'>
          <stop stopColor='#5098EA' offset='0%' />
          <stop stopColor='#458BDB' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='aw-linearGradient-3'>
          <stop stopColor='#E82045' offset='0%' />
          <stop stopColor='#D01739' offset='100%' />
        </linearGradient>
      </defs>
      <g id='aw-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='aw-AW'>
          <rect
            id='aw-FlagBackground'
            fill='url(#aw-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          <polygon
            id='aw-Star'
            fill='url(#aw-linearGradient-3)'
            points='3.75 5.25 2 4.5 3.75 3.75 4.5 2 5.25 3.75 7 4.5 5.25 5.25 4.5 7'
          />
          <rect id='aw-Rectangle-1337' fill='#F9D536' x='0' y='11' width='21' height='1' />
          <rect id='aw-Rectangle-1337-Copy' fill='#F9D536' x='0' y='9' width='21' height='1' />
        </g>
      </g>
    </svg>
  )
