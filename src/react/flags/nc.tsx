...
export const IconFlagNC = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='nc-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='nc-linearGradient-2'>
          <stop stopColor='#094CC7' offset='0%' />
          <stop stopColor='#003CAB' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='nc-linearGradient-3'>
          <stop stopColor='#2AAD55' offset='0%' />
          <stop stopColor='#219447' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='nc-linearGradient-4'>
          <stop stopColor='#F65D55' offset='0%' />
          <stop stopColor='#E9443C' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='nc-linearGradient-5'>
          <stop stopColor='#FAE749' offset='0%' />
          <stop stopColor='#FBE533' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='nc-linearGradient-6'>
          <stop stopColor='#262626' offset='0%' />
          <stop stopColor='#0D0D0D' offset='100%' />
        </linearGradient>
      </defs>
      <g id='nc-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='nc-NC'>
          <rect
            id='nc-FlagBackground'
            fill='url(#nc-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          <rect
            id='nc-Rectangle-2'
            fill='url(#nc-linearGradient-4)'
            x='0'
            y='5'
            width='21'
            height='5'
          />
          <circle id='nc-Oval-95' fill='url(#nc-linearGradient-5)' cx='10.5' cy='7.5' r='3.5' />
          <path
            ...
            id='nc-Combined-Shape'
            fill='url(#nc-linearGradient-6)'
          />
        </g>
      </g>
    </svg>
