...
export const IconFlagSK = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='sk-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='sk-linearGradient-2'>
          <stop stopColor='#0C47B7' offset='0%' />
          <stop stopColor='#073DA4' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='sk-linearGradient-3'>
          <stop stopColor='#E53B35' offset='0%' />
          <stop stopColor='#D32E28' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='sk-linearGradient-4'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='sk-linearGradient-5'>
      ...
      <g id='sk-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='sk-SK'>
          <rect
            id='sk-FlagBackground'
            fill='url(#sk-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          <rect
            ...
            height='5'
          />
          <g id='sk-Rectangle-1693' transform='translate(2.500000, 2.000000)'>
            <path
              ...
              id='sk-Mask'
              fill='url(#sk-linearGradient-4)'
              fillRule='nonzero'
            />
            <mask id='sk-mask-7' fill='white'>
              <use xlinkHref='#sk-path-6' />
            </mask>
            <use id='sk-Mask' fill='url(#sk-linearGradient-5)' xlinkHref='#sk-path-6' />
            <path
