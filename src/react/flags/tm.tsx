...
export const IconFlagTM = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        ...
        <ellipse id='tm-path-4' cx='1.5' cy='1' rx='1.5' ry='1' />
        <ellipse id='tm-path-6' cx='1.5' cy='1' rx='1.5' ry='1' />
        <ellipse id='tm-path-8' cx='1.5' cy='1' rx='1.5' ry='1' />
        <ellipse id='tm-path-10' cx='1.5' cy='0.5' rx='1.5' ry='1' />
        <ellipse id='tm-path-12' cx='1.5' cy='1' rx='1.5' ry='1' />
      </defs>
      <g id='tm-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='tm-TM'>
          <rect
            id='tm-FlagBackground'
            fill='url(#tm-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          />
          <rect
            id='tm-Rectangle-1092'
            fill='url(#tm-linearGradient-3)'
            x='3'
            y='0'
            width='3'
            height='15'
          />
          <g id='tm-Oval-161' transform='translate(3.000000, 1.000000)'>
            <mask id='tm-mask-5' fill='white'>
              <use xlinkHref='#tm-path-4' />
            </mask>
            <use id='tm-Mask' fill='#FFFFFF' xlinkHref='#tm-path-4' />
            <circle id='tm-Oval-166' fill='#DD404F' mask='url(#tm-mask-5)' cx='1.5' cy='1' r='1' />
            <rect
              id='tm-Rectangle-1093'
              fill='#FBAF29'
              mask='url(#tm-mask-5)'
              x='0'
              y='0'
          ...
          <g id='tm-Oval-161-Copy-2' transform='translate(3.000000, 12.000000)'>
            <mask id='tm-mask-7' fill='white'>
              <use xlinkHref='#tm-path-6' />
            </mask>
            <use id='tm-Mask' fill='#FFFFFF' xlinkHref='#tm-path-6' />
            <circle id='tm-Oval-166' fill='#DD404F' mask='url(#tm-mask-7)' cx='1.5' cy='1' r='1' />
            <rect
              id='tm-Rectangle-1093'
              fill='#FBAF29'
              mask='url(#tm-mask-7)'
          ...
          <g id='tm-Oval-161-Copy-3' transform='translate(3.000000, 7.000000)'>
            <mask id='tm-mask-9' fill='white'>
              <use xlinkHref='#tm-path-8' />
            </mask>
            <use id='tm-Mask' fill='#28AE67' xlinkHref='#tm-path-8' />
            <ellipse
              id='tm-Oval-166'
              fill='#DD404F'
              mask='url(#tm-mask-9)'
          ...
          <g id='tm-Oval-161-Copy-4' transform='translate(3.000000, 10.000000)'>
            <mask id='tm-mask-11' fill='white'>
              <use xlinkHref='#tm-path-10' />
            </mask>
            <use id='tm-Mask' fill='#28AE67' xlinkHref='#tm-path-10' />
          </g>
          <g id='tm-Oval-161-Copy' transform='translate(3.000000, 4.000000)'>
            <mask id='tm-mask-13' fill='white'>
              <use xlinkHref='#tm-path-12' />
            </mask>
            <use id='tm-Mask' fill='#FBAF29' xlinkHref='#tm-path-12' />
            <circle id='tm-Oval-166' fill='#DD404F' mask='url(#tm-mask-13)' cx='1.5' cy='1' r='1' />
            <rect
              id='tm-Rectangle-1093'
              fill='#28AE67'
              mask='url(#tm-mask-13)'
