...
export const IconFlagUY: FlagIcon = ({ className, ...props }: FlagIconProps) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='uy-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='uy-linearGradient-2'>
          <stop stopColor='#0E4DC5' offset='0%' />
          <stop stopColor='#073DA6' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='uy-linearGradient-3'>
          <stop stopColor='#FED443' offset='0%' />
          <stop stopColor='#FCD036' offset='100%' />
        </linearGradient>
      </defs>
      <g id='uy-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='uy-UY'>
          <rect
            id='uy-FlagBackground'
            fill='url(#uy-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
