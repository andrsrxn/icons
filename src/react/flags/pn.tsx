...
export const IconFlagPN = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='pn-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='pn-linearGradient-2'>
          <stop stopColor='#07319C' offset='0%' />
          <stop stopColor='#00247E' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='pn-linearGradient-3'>
        ...
        <path
          ...
          id='pn-path-4'
        />
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='pn-linearGradient-6'>
          <stop stopColor='#F7E14A' offset='0%' />
          <stop stopColor='#F7DE38' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='pn-linearGradient-7'>
          <stop stopColor='#4B8C36' offset='0%' />
          <stop stopColor='#397127' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='pn-linearGradient-8'>
          <stop stopColor='#DB1E36' offset='0%' />
          <stop stopColor='#D51931' offset='100%' />
        </linearGradient>
      </defs>
      <g id='pn-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='pn-PN'>
          <rect
            id='pn-FlagBackground'
            fill='url(#pn-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          <rect
            id='pn-Mask-Copy'
            fill='url(#pn-linearGradient-2)'
            x='0'
            y='0'
            width='21'
            height='15'
          />
          <g id='pn-Rectangle-1105' transform='translate(13.000000, 6.000000)'>
            <mask id='pn-mask-5' fill='white'>
              <use xlinkHref='#pn-path-4' />
            </mask>
            <use id='pn-Combined-Shape' fill='url(#pn-linearGradient-3)' xlinkHref='#pn-path-4' />
            <polygon
              id='pn-Rectangle-1293'
              fill='url(#pn-linearGradient-6)'
              fillRule='nonzero'
              mask='url(#pn-mask-5)'
