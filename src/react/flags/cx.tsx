...
export const IconFlagCX: FlagIcon = ({ className, ...props }: FlagIconProps) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='cx-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='cx-linearGradient-2'>
          <stop stopColor='#0637C5' offset='0%' />
          <stop stopColor='#002CAA' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='cx-linearGradient-3'>
          <stop stopColor='#3BA758' offset='0%' />
          <stop stopColor='#2C8945' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='cx-linearGradient-4'>
          <stop stopColor='#FFCC5D' offset='0%' />
          <stop stopColor='#FEC54A' offset='100%' />
        </linearGradient>
      </defs>
      <g id='cx-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='cx-CX'>
          <rect
            id='cx-FlagBackground'
            fill='url(#cx-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          <path
            ...
            id='cx-Rectangle-1235'
            fill='url(#cx-linearGradient-4)'
          />
          <path
