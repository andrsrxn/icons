...
export const IconFlagEG = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='eg-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='eg-linearGradient-2'>
          <stop stopColor='#E41D33' offset='0%' />
          <stop stopColor='#CE1126' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='eg-linearGradient-3'>
          <stop stopColor='#262626' offset='0%' />
          <stop stopColor='#0D0D0D' offset='100%' />
        </linearGradient>
      </defs>
      <g id='eg-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='eg-EG'>
          <rect
            id='eg-FlagBackground'
            fill='url(#eg-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
