...
export const IconFlagGBNIR: FlagIcon = ({ className, ...props }: FlagIconProps) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gb-nir-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gb-nir-linearGradient-2'>
          <stop stopColor='#E82739' offset='0%' />
          <stop stopColor='#CA1A2B' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gb-nir-linearGradient-3'>
          <stop stopColor='#E6101E' offset='0%' />
          <stop stopColor='#CA0814' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gb-nir-linearGradient-4'>
      ...
      <g id='gb-nir-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='gb-nir-GB-NIR'>
          <rect
            id='gb-nir-FlagBackground'
            fill='url(#gb-nir-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          <path
            ...
            id='gb-nir-Rectangle-2'
            fill='url(#gb-nir-linearGradient-2)'
          />
          <polygon
            id='gb-nir-Star'
            fill='url(#gb-nir-linearGradient-1)'
          ...
          <path
            ...
            id='gb-nir-Rectangle'
            fill='url(#gb-nir-linearGradient-3)'
          />
          <path
            ...
            fillRule='nonzero'
          />
          <mask id='gb-nir-mask-6' fill='white'>
            <use xlinkHref='#gb-nir-path-5' />
          </mask>
          <use
            id='gb-nir-Combined-Shape'
            fill='url(#gb-nir-linearGradient-4)'
            xlinkHref='#gb-nir-path-5'
          />
          <circle
            id='gb-nir-Oval-7'
            fill='#5169E2'
            mask='url(#gb-nir-mask-6)'
            cx='10.5'
            cy='4.5'
            r='1'
          />
          <circle
            id='gb-nir-Oval-7-Copy'
            fill='#D34D43'
            mask='url(#gb-nir-mask-6)'
            cx='11.5'
            cy='4.5'
