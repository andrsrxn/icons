...
export const IconFlagKG = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <g id='kg-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='kg-KG'>
          <rect
            id='kg-FlagBackground'
            fill='url(#kg-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          <rect
            id='kg-Mask-Copy'
            fill='url(#kg-linearGradient-2)'
            x='0'
            y='0'
            width='21'
            height='15'
          />
          <circle id='kg-Oval-9' fill='url(#kg-linearGradient-3)' cx='10.5' cy='7.5' r='2.5' />
          <path
