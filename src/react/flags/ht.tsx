...
export const IconFlagHT = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='ht-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='ht-linearGradient-2'>
          <stop stopColor='#112EBC' offset='0%' />
          <stop stopColor='#0620A0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='ht-linearGradient-3'>
          <stop stopColor='#E3264A' offset='0%' />
          <stop stopColor='#D20F34' offset='100%' />
        </linearGradient>
        <rect id='ht-path-4' x='0' y='0' width='7' height='6' rx='0.5' />
        <path
      ...
      <g id='ht-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='ht-HT'>
          <rect
            id='ht-FlagBackground'
            fill='url(#ht-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          <rect
            id='ht-Rectangle-2'
            fill='url(#ht-linearGradient-3)'
            x='0'
            y='7'
            width='21'
            height='8'
          />
          <g id='ht-Rectangle-180' transform='translate(7.000000, 5.000000)'>
            <mask id='ht-mask-5' fill='white'>
              <use xlinkHref='#ht-path-4' />
            </mask>
            <use id='ht-Mask' fill='url(#ht-linearGradient-1)' xlinkHref='#ht-path-4' />
            <g id='ht-Rectangle-181' mask='url(#ht-mask-5)'>
              <use fill='#AABCAE' fillRule='evenodd' xlinkHref='#ht-path-6' />
              <path
                stroke='#366C14'
                strokeWidth='0.5'
            ...
            <circle
              ...
              r='1.5'
            />
            <g id='ht-Rectangle-182' mask='url(#ht-mask-5)'>
              <use fill='#C28321' fillRule='evenodd' xlinkHref='#ht-path-7' />
              <path
                stroke='#0D3488'
                strokeWidth='0.5'
