...
export const IconFlagUM = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='um-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='um-linearGradient-2'>
          <stop stopColor='#D02F44' offset='0%' />
          <stop stopColor='#B12537' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='um-linearGradient-3'>
          <stop stopColor='#46467F' offset='0%' />
          <stop stopColor='#3C3C6D' offset='100%' />
        </linearGradient>
      </defs>
      <g id='um-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='um-UM'>
          <rect
            id='um-FlagBackground'
            fill='url(#um-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          <path
            ...
            id='um-Rectangle-511'
            fill='url(#um-linearGradient-2)'
          />
          <rect
            id='um-Rectangle-511'
            fill='url(#um-linearGradient-3)'
            x='0'
            y='0'
            width='9'
            height='7'
