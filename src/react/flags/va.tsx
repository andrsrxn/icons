...
export const IconFlagVA: FlagIcon = ({ className, ...props }: FlagIconProps) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='va-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='va-linearGradient-2'>
          <stop stopColor='#FDE048' offset='0%' />
          <stop stopColor='#FFDF32' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='va-linearGradient-3'>
          <stop stopColor='#CDCCCC' offset='0%' />
          <stop stopColor='#E4E4E4' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='va-linearGradient-4'>
          <stop stopColor='#CD9D25' offset='0%' />
          <stop stopColor='#EBB93A' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='va-linearGradient-5'>
          <stop stopColor='#F5252C' offset='0%' />
          <stop stopColor='#F6151C' offset='100%' />
        </linearGradient>
      </defs>
      <g id='va-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='va-VA'>
          <rect
            id='va-FlagBackground'
            fill='url(#va-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          />
          <rect
            id='va-Rectangle-2-Copy-2'
            fill='url(#va-linearGradient-2)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          <path
            ...
            id='va-Combined-Shape'
            fill='url(#va-linearGradient-3)'
          ...
          <path
            ...
            id='va-Combined-Shape-Copy'
            fill='url(#va-linearGradient-4)'
