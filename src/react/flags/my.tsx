...
export const IconFlagMY = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='my-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='my-linearGradient-2'>
          <stop stopColor='#E1244A' offset='0%' />
          <stop stopColor='#BE1134' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='my-linearGradient-3'>
          <stop stopColor='#0C3F8E' offset='0%' />
          <stop stopColor='#032A67' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='my-linearGradient-4'>
          <stop stopColor='#FFD34F' offset='0%' />
          <stop stopColor='#FFCB2F' offset='100%' />
        </linearGradient>
      </defs>
      <g id='my-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='my-MY'>
          <rect
            id='my-FlagBackground'
            fill='url(#my-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          <path
            ...
            id='my-Rectangle-537'
            fill='url(#my-linearGradient-2)'
          />
          <rect
            id='my-Rectangle-1568'
            fill='url(#my-linearGradient-3)'
            x='0'
            y='0'
            width='12'
            height='8'
