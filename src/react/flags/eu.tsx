...
export const IconFlagEU: FlagIcon = ({ className, ...props }: FlagIconProps) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='eu-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='eu-linearGradient-2'>
          <stop stopColor='#043CAE' offset='0%' />
          <stop stopColor='#00339A' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='eu-linearGradient-3'>
          <stop stopColor='#FFD429' offset='0%' />
          <stop stopColor='#FFCC00' offset='100%' />
        </linearGradient>
      </defs>
      <g id='eu-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='eu-EU'>
          <rect
            id='eu-FlagBackground'
            fill='url(#eu-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
