...
export const IconFlagNF = ({ className, ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='nf-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='nf-linearGradient-2'>
          <stop stopColor='#219646' offset='0%' />
          <stop stopColor='#197837' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='nf-linearGradient-3'>
          <stop stopColor='#259D4B' offset='0%' />
          <stop stopColor='#197837' offset='100%' />
        </linearGradient>
      </defs>
      <g id='nf-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='nf-NF'>
          <rect
            id='nf-FlagBackground'
            fill='url(#nf-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          />
          <rect id='nf-Mask' fill='url(#nf-linearGradient-2)' x='10' y='0' width='11' height='15' />
          <rect
            id='nf-Rectangle-2'
            fill='url(#nf-linearGradient-2)'
            x='0'
            y='0'
            width='7'
            height='15'
          ...
          <path
            ...
            id='nf-Combined-Shape'
            fill='url(#nf-linearGradient-3)'
          />
        </g>
      </g>
    </svg>
