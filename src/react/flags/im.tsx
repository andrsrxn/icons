...
export const IconFlagIM: FlagIcon = ({ className, ...props }: FlagIconProps) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='im-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='im-linearGradient-2'>
          <stop stopColor='#E52D42' offset='0%' />
          <stop stopColor='#CB1D31' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='im-linearGradient-3'>
          <stop stopColor='#F8DD4E' offset='0%' />
          <stop stopColor='#F9DA38' offset='100%' />
        </linearGradient>
      </defs>
      <g id='im-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='im-IM'>
          <rect
            id='im-FlagBackground'
            fill='url(#im-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          <rect
            id='im-Mask-Copy'
            fill='url(#im-linearGradient-2)'
            x='0'
            y='0'
            width='21'
            height='15'
          />
          <g id='im-Group' transform='translate(4.000000, 1.500000)'>
            <path
            ...
            <path
              ...
              id='im-Combined-Shape'
              fill='url(#im-linearGradient-3)'
            />
          </g>
        </g>
      </g>
