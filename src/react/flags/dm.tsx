...
export const IconFlagDM: FlagIcon = ({ className, ...props }: FlagIconProps) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <g id='dm-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='dm-DM'>
          <rect
            id='dm-FlagBackground'
            fill='url(#dm-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
