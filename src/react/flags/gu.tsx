...
export const IconFlagGU: FlagIcon = ({ className, ...props }: FlagIconProps) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gu-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gu-linearGradient-2'>
          <stop stopColor='#DE3149' offset='0%' />
          <stop stopColor='#C2273D' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gu-linearGradient-3'>
          <stop stopColor='#053B94' offset='0%' />
          <stop stopColor='#002E7A' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gu-linearGradient-4'>
          <stop stopColor='#DE3149' offset='0%' />
          <stop stopColor='#C2273D' offset='100%' />
        </linearGradient>
        <path
          ...
          id='gu-path-5'
        />
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gu-linearGradient-7'>
          <stop stopColor='#81C1F3' offset='0%' />
          <stop stopColor='#6AB1E9' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gu-linearGradient-8'>
          <stop stopColor='#27A07E' offset='0%' />
          <stop stopColor='#1F9171' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gu-linearGradient-9'>
          <stop stopColor='#1E8CE8' offset='0%' />
          <stop stopColor='#107FDC' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gu-linearGradient-10'>
          <stop stopColor='#FFF048' offset='0%' />
          <stop stopColor='#FFEF36' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='gu-linearGradient-11'>
          <stop stopColor='#8F5715' offset='0%' />
          <stop stopColor='#7A480D' offset='100%' />
        </linearGradient>
      </defs>
      <g id='gu-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='gu-GU'>
          <rect
            id='gu-FlagBackground'
            fill='url(#gu-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          />
          <rect
            id='gu-Rectangle-1568'
            fill='url(#gu-linearGradient-3)'
            x='1'
            y='1'
            width='19'
            height='13'
          ...
          <path
            ...
            id='gu-Oval-226'
            fill='url(#gu-linearGradient-4)'
          />
          <g id='gu-Group' transform='translate(8.000000, 3.000000)'>
            <mask id='gu-mask-6' fill='white'>
              <use xlinkHref='#gu-path-5' />
            </mask>
            <use id='gu-Oval-226-Copy' fill='url(#gu-linearGradient-1)' xlinkHref='#gu-path-5' />
            <rect
              id='gu-Rectangle-1248'
              fill='url(#gu-linearGradient-7)'
              mask='url(#gu-mask-6)'
              x='0'
              y='0'
              width='5'
            ...
            />
            <rect
              id='gu-Rectangle-1248-Copy'
              fill='url(#gu-linearGradient-9)'
              mask='url(#gu-mask-6)'
              x='0'
              y='5'
              width='5'
            ...
            <path
              ...
              id='gu-Rectangle-1248-Copy-2'
              fill='url(#gu-linearGradient-10)'
              mask='url(#gu-mask-6)'
            />
          </g>
          <path
            ...
            id='gu-Line'
            fill='url(#gu-linearGradient-11)'
            fillRule='nonzero'
          />
          <polygon id='gu-Rectangle-1251' fill='#FFFFFF' points='9 7.5 10 9 9 9' />
        </g>
      </g>
    </svg>
  )
