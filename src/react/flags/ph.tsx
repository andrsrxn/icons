...
export const IconFlagPH: FlagIcon = ({ className, ...props }: FlagIconProps) => {
  return (
    <svg
      width='21px'
      height='15px'
      ...
      <defs>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='ph-linearGradient-1'>
          <stop stopColor='#FFFFFF' offset='0%' />
          <stop stopColor='#F0F0F0' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='ph-linearGradient-2'>
          <stop stopColor='#DD1C34' offset='0%' />
          <stop stopColor='#CC162C' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='ph-linearGradient-3'>
          <stop stopColor='#0D4BC3' offset='0%' />
          <stop stopColor='#073DA6' offset='100%' />
        </linearGradient>
        <linearGradient x1='50%' y1='0%' x2='50%' y2='100%' id='ph-linearGradient-4'>
          <stop stopColor='#FDD64D' offset='0%' />
          <stop stopColor='#FCD036' offset='100%' />
        </linearGradient>
      </defs>
      <g id='ph-Symbols' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='ph-PH'>
          <rect
            id='ph-FlagBackground'
            fill='url(#ph-linearGradient-1)'
            x='0'
            y='0'
            width='21'
            height='15'
          ...
          <rect
            id='ph-Rectangle-2'
            fill='url(#ph-linearGradient-3)'
            x='0'
            y='0'
            width='21'
            height='7'
          />
          <polygon id='ph-Rectangle-83' fill='url(#ph-linearGradient-1)' points='0 0 10 7.5 0 15' />
          <path
